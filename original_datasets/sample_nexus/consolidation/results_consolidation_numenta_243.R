...
load(file="~/janio/harbinger/dev/results/result_243_arima_numenta_art_anom.RData")
load(file="~/janio/harbinger/dev/results/result_243_garch_numenta_art_anom.RData")
load(file="~/janio/harbinger/dev/results/result_243_cf_lr_numenta_art_anom.RData")
load(file="~/janio/harbinger/dev/results/result_243_ml_lstm_numenta_art_anom.RData")
data(numenta_artificialWithAnomaly)

#Resume
numenta_243_cons <- list()
numenta_243_cons_overall <- list()
...
for (k in 1:length(result_243_fbiad_numenta_art_anom)) {
  ev_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(result_243_fbiad_numenta_art_anom[[k]]$detector,
             result_243_fbiad_numenta_art_anom[[k]]$detection$event,
...
ev_soft_numenta_243_fbiad <- list()

k = 1
for (k in 1:length(result_243_fbiad_numenta_art_anom)) {
  ev_soft_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_fbiad_numenta_art_anom[[k]]$detection$event),
...
names(ev_soft_numenta_243_fbiad) <- names(numenta_artificialWithAnomaly$artificialWithAnomaly)


## METRICS
#Accuracy
acc_numenta_243_fbiad <- c() #All series to create overall results
numenta_243_cons$acc <- data.frame() #By Series
...
numenta_243_cons$acc <- rbind(numenta_243_cons$acc,
                             c(method = "FBIAD_ArtAnom",
                               value = mean(acc_partial, na.rm = TRUE)))


names(numenta_243_cons$acc) <- c("method", "value")
numenta_243_cons$acc


#F1
f1_numenta_243_fbiad <- c() #All series to create overall results
numenta_243_cons$f1 <- data.frame() #By Series
...
numenta_243_cons$f1 <- rbind(numenta_243_cons$f1,
                             c(method = "FBIAD_ArtAnom",
                               value = mean(f1_partial, na.rm = TRUE)))


names(numenta_243_cons$f1) <- c("method", "value")
numenta_243_cons$f1


#F1_soft
f1_soft_numenta_243_fbiad <- c() #All series to create overall results
numenta_243_cons$f1_soft <- data.frame() #By Series


f1_soft_partial <- c()
j = 1
for (j in 1:length(ev_soft_numenta_243_fbiad)) {
  f1_soft_partial <- tryCatch({
    append(f1_soft_partial, ev_soft_numenta_243_fbiad[[j]]$F1)
  }, error = function(e) {
    message(e)
    return(append(f1_soft_partial, NA))
  })
  f1_soft_numenta_243_fbiad <- append(f1_soft_numenta_243_fbiad, f1_soft_partial)
}

numenta_243_cons$f1_soft <- rbind(numenta_243_cons$f1_soft,
                                 c(method = "FBIAD_ArtAnom",
                                   value = mean(f1_soft_partial, na.rm = TRUE)))


names(numenta_243_cons$f1_soft) <- c("method", "value")
numenta_243_cons$f1_soft


#Time
time_per_batch_numenta_243_fbiad <- c() #All series
numenta_243_cons$time_per_batch <- data.frame()
...
j = 1
for (j in 1:length(result_243_fbiad_numenta_art_anom)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_fbiad_numenta_art_anom[[j]]$time))
  }, error = function(e) {
    message(e)
...
time_per_batch_numenta_243_fbiad <- append(time_per_batch_numenta_243_fbiad,
                                          time_bt_partial)


numenta_243_cons$time_per_batch <- rbind(numenta_243_cons$time_per_batch,
                                        c(method = "FBIAD_ArtAnom",
                                          value = mean(time_bt_partial, na.rm = TRUE)))

names(numenta_243_cons$time_per_batch) <- c("method", "value")
numenta_243_cons
...
for (k in 1:length(result_243_arima_numenta_art_anom)) {
  ev_numenta_243_arima[[k]] <- tryCatch({
    evaluate(result_243_arima_numenta_art_anom[[k]]$detector,
             result_243_arima_numenta_art_anom[[k]]$detection$event,
             numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
ev_soft_numenta_243_arima <- list()

k = 1
for (k in 1:length(result_243_arima_numenta_art_anom)) {
  ev_soft_numenta_243_arima[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_arima_numenta_art_anom[[k]]$detection$event),
             as.logical(numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_arima) <- names(numenta_artificialWithAnomaly$artificialWithAnomaly)
...
#F1_soft
f1_soft_numenta_243_arima <- c() #All series to create overall results


f1_soft_partial <- c()
j = 1
for (j in 1:length(ev_soft_numenta_243_arima)) {
  f1_soft_partial <- tryCatch({
    append(f1_soft_partial, ev_soft_numenta_243_arima[[j]]$F1)
  }, error = function(e) {
    message(e)
    return(append(f1_soft_partial, NA))
  })
  f1_soft_numenta_243_arima <- append(f1_soft_numenta_243_arima, f1_soft_partial)
}
...
#Time
time_per_batch_numenta_243_arima <- c() #All series
...
j = 1
for (j in 1:length(result_243_arima_numenta_art_anom)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_arima_numenta_art_anom[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
#Adicionar tempos para cálculo da média geral de todos os grupos
time_per_batch_numenta_243_arima <- append(time_per_batch_numenta_243_arima,
                                          time_bt_partial)
...
for (k in 1:length(result_243_garch_numenta_art_anom)) {
  ev_numenta_243_garch[[k]] <- tryCatch({
    evaluate(result_243_garch_numenta_art_anom[[k]]$detector,
             result_243_garch_numenta_art_anom[[k]]$detection$event,
             numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_garch_numenta_art_anom)) {
  ev_soft_numenta_243_garch[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_garch_numenta_art_anom[[k]]$detection$event),
             as.logical(numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_garch) <- names(numenta_artificialWithAnomaly$artificialWithAnomaly)
...
#F1_soft
f1_soft_numenta_243_garch <- c() #All series to create overall results
...
for (j in 1:length(ev_soft_numenta_243_garch)) {
  ...
  f1_soft_numenta_243_garch <- append(f1_soft_numenta_243_garch, f1_soft_partial)
}
...
#Time
time_per_batch_numenta_243_garch <- c() #All series
...
j = 1
for (j in 1:length(result_243_garch_numenta_art_anom)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_garch_numenta_art_anom[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
#Adicionar tempos para cálculo da média geral de todos os grupos
time_per_batch_numenta_243_garch <- append(time_per_batch_numenta_243_garch,
                                          time_bt_partial)
...
for (k in 1:length(result_243_cf_lr_numenta_art_anom)) {
  ev_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(result_243_cf_lr_numenta_art_anom[[k]]$detector,
             result_243_cf_lr_numenta_art_anom[[k]]$detection$event,
             numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_cf_lr_numenta_art_anom)) {
  ev_soft_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_cf_lr_numenta_art_anom[[k]]$detection$event),
             as.logical(numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_cf_lr) <- names(numenta_artificialWithAnomaly$artificialWithAnomaly)
...
#F1_soft
f1_soft_numenta_243_cf_lr <- c() #All series to create overall results
...
for (j in 1:length(ev_soft_numenta_243_cf_lr)) {
  ...
  f1_soft_numenta_243_cf_lr <- append(f1_soft_numenta_243_cf_lr, f1_soft_partial)
}
...
#Time
time_per_batch_numenta_243_cf_lr <- c() #All series
...
j = 1
for (j in 1:length(result_243_cf_lr_numenta_art_anom)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_cf_lr_numenta_art_anom[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
#Adicionar tempos para cálculo da média geral de todos os grupos
time_per_batch_numenta_243_cf_lr <- append(time_per_batch_numenta_243_cf_lr,
                                          time_bt_partial)
...
for (k in 1:length(result_243_ml_lstm_numenta_art_anom)) {
  ev_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(result_243_ml_lstm_numenta_art_anom[[k]]$detector,
             result_243_ml_lstm_numenta_art_anom[[k]]$detection$event,
             numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_ml_lstm_numenta_art_anom)) {
  ev_soft_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_ml_lstm_numenta_art_anom[[k]]$detection$event),
             as.logical(numenta_artificialWithAnomaly$artificialWithAnomaly[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_ml_lstm) <- names(numenta_artificialWithAnomaly$artificialWithAnomaly)
...
#F1_soft
f1_soft_numenta_243_ml_lstm <- c() #All series to create overall results
...
for (j in 1:length(ev_soft_numenta_243_ml_lstm)) {
  ...
  f1_soft_numenta_243_ml_lstm <- append(f1_soft_numenta_243_ml_lstm, f1_soft_partial)
}
...
#Time
time_per_batch_numenta_243_ml_lstm <- c() #All series
...
j = 1
for (j in 1:length(result_243_ml_lstm_numenta_art_anom)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_ml_lstm_numenta_art_anom[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
#Adicionar tempos para cálculo da média geral de todos os grupos
time_per_batch_numenta_243_ml_lstm <- append(time_per_batch_numenta_243_ml_lstm,
                                            time_bt_partial)
...
#Before use loaded data verify if it have the complete experiment results
#If not sure, use individual files instead of complete experiment
load(file="~/janio/harbinger/dev/results/result_243_fbiad_numenta_real_adexc.RData")
load(file="~/janio/harbinger/dev/results/result_243_arima_numenta_real_adexc.RData")
load(file="~/janio/harbinger/dev/results/result_243_garch_numenta_real_adexc.RData")
load(file="~/janio/harbinger/dev/results/result_243_cf_lr_numenta_real_adexc.RData")
load(file="~/janio/harbinger/dev/results/result_243_ml_lstm_numenta_real_adexc.RData")
data(numenta_realAdExchange)


#Cleaning the results to manage session memory and avoid mistakes
rm(result_243_arima_numenta_art_anom)
rm(result_243_cf_lr_numenta_art_anom)
rm(result_243_fbiad_numenta_art_anom)
rm(result_243_garch_numenta_art_anom)
rm(result_243_ml_lstm_numenta_art_anom)
rm(numenta_artificialWithAnomaly)



#FBIAD =========
ev_numenta_243_fbiad <- list() #Restart EV for each series group

k = 1
for (k in 1:length(result_243_fbiad_numenta_real_adexc)) {
  ev_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(result_243_fbiad_numenta_real_adexc[[k]]$detector,
             result_243_fbiad_numenta_real_adexc[[k]]$detection$event,
...
ev_soft_numenta_243_fbiad <- list() #Restart soft EV for each series group

k = 1
for (k in 1:length(result_243_fbiad_numenta_real_adexc)) {
  ev_soft_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_fbiad_numenta_real_adexc[[k]]$detection$event),
...
names(ev_soft_numenta_243_fbiad) <- names(numenta_realAdExchange$realAdExchange)
...
j = 1
for (j in 1:length(result_243_fbiad_numenta_real_adexc)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_fbiad_numenta_real_adexc[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_arima_numenta_real_adexc)) {
  ev_numenta_243_arima[[k]] <- tryCatch({
    evaluate(result_243_arima_numenta_real_adexc[[k]]$detector,
             result_243_arima_numenta_real_adexc[[k]]$detection$event,
             numenta_realAdExchange$realAdExchange[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_arima_numenta_real_adexc)) {
  ev_soft_numenta_243_arima[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_arima_numenta_real_adexc[[k]]$detection$event),
             as.logical(numenta_realAdExchange$realAdExchange[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_arima) <- names(numenta_realAdExchange$realAdExchange)
...
j = 1
for (j in 1:length(result_243_arima_numenta_real_adexc)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_arima_numenta_real_adexc[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_garch_numenta_real_adexc)) {
  ev_numenta_243_garch[[k]] <- tryCatch({
    evaluate(result_243_garch_numenta_real_adexc[[k]]$detector,
             result_243_garch_numenta_real_adexc[[k]]$detection$event,
             numenta_realAdExchange$realAdExchange[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_garch_numenta_real_adexc)) {
  ev_soft_numenta_243_garch[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_garch_numenta_real_adexc[[k]]$detection$event),
             as.logical(numenta_realAdExchange$realAdExchange[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_garch_numenta_real_adexc)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_garch_numenta_real_adexc[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_cf_lr_numenta_real_adexc)) {
  ev_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(result_243_cf_lr_numenta_real_adexc[[k]]$detector,
             result_243_cf_lr_numenta_real_adexc[[k]]$detection$event,
             numenta_realAdExchange$realAdExchange[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_cf_lr_numenta_real_adexc)) {
  ev_soft_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_cf_lr_numenta_real_adexc[[k]]$detection$event),
             as.logical(numenta_realAdExchange$realAdExchange[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_cf_lr_numenta_real_adexc)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_cf_lr_numenta_real_adexc[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_ml_lstm_numenta_real_adexc)) {
  ev_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(result_243_ml_lstm_numenta_real_adexc[[k]]$detector,
             result_243_ml_lstm_numenta_real_adexc[[k]]$detection$event,
             numenta_realAdExchange$realAdExchange[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_ml_lstm_numenta_real_adexc)) {
  ev_soft_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_ml_lstm_numenta_real_adexc[[k]]$detection$event),
             as.logical(numenta_realAdExchange$realAdExchange[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_ml_lstm_numenta_real_adexc)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_ml_lstm_numenta_real_adexc[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
## Final tasks ===============
#Cleaning the results to manage session memory and avoid mistakes
rm(result_243_arima_numenta_real_adexc)
rm(result_243_cf_lr_numenta_real_adexc)
rm(result_243_fbiad_numenta_real_adexc)
rm(result_243_garch_numenta_real_adexc)
rm(result_243_ml_lstm_numenta_real_adexc)
...
#Before use loaded data verify if it have the complete experiment results
#If not sure, use individual files instead of complete experiment
load(file="~/janio/harbinger/dev/results/result_243_fbiad_numenta_real_aws.RData")
load(file="~/janio/harbinger/dev/results/result_243_arima_numenta_real_aws.RData")
load(file="~/janio/harbinger/dev/results/result_243_garch_numenta_real_aws.RData")
load(file="~/janio/harbinger/dev/results/result_243_cf_lr_numenta_real_aws.RData")
load(file="~/janio/harbinger/dev/results/result_243_ml_lstm_numenta_real_aws.RData")
...
for (k in 1:length(result_243_fbiad_numenta_real_aws)) {
  ev_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(result_243_fbiad_numenta_real_aws[[k]]$detector,
             result_243_fbiad_numenta_real_aws[[k]]$detection$event,
...
for (k in 1:length(result_243_fbiad_numenta_real_aws)) {
  ev_soft_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_fbiad_numenta_real_aws[[k]]$detection$event),
...
names(ev_soft_numenta_243_fbiad) <- names(numenta_realAWSCloudwatch$realAWSCloudwatch)
...
j = 1
for (j in 1:length(result_243_fbiad_numenta_real_aws)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_fbiad_numenta_real_aws[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_arima_numenta_real_aws)) {
  ev_numenta_243_arima[[k]] <- tryCatch({
    evaluate(result_243_arima_numenta_real_aws[[k]]$detector,
             result_243_arima_numenta_real_aws[[k]]$detection$event,
             numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_arima_numenta_real_aws)) {
  ev_soft_numenta_243_arima[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_arima_numenta_real_aws[[k]]$detection$event),
             as.logical(numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_arima) <- names(numenta_realAWSCloudwatch$realAWSCloudwatch)
...
j = 1
for (j in 1:length(result_243_arima_numenta_real_aws)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_arima_numenta_real_aws[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_garch_numenta_real_aws)) {
  ev_numenta_243_garch[[k]] <- tryCatch({
    evaluate(result_243_garch_numenta_real_aws[[k]]$detector,
             result_243_garch_numenta_real_aws[[k]]$detection$event,
             numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_garch_numenta_real_aws)) {
  ev_soft_numenta_243_garch[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_garch_numenta_real_aws[[k]]$detection$event),
             as.logical(numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_garch_numenta_real_aws)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_garch_numenta_real_aws[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_cf_lr_numenta_real_aws)) {
  ev_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(result_243_cf_lr_numenta_real_aws[[k]]$detector,
             result_243_cf_lr_numenta_real_aws[[k]]$detection$event,
             numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_cf_lr_numenta_real_aws)) {
  ev_soft_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_cf_lr_numenta_real_aws[[k]]$detection$event),
             as.logical(numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_cf_lr_numenta_real_aws)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_cf_lr_numenta_real_aws[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_ml_lstm_numenta_real_aws)) {
  ev_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(result_243_ml_lstm_numenta_real_aws[[k]]$detector,
             result_243_ml_lstm_numenta_real_aws[[k]]$detection$event,
             numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_ml_lstm_numenta_real_aws)) {
  ev_soft_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_ml_lstm_numenta_real_aws[[k]]$detection$event),
             as.logical(numenta_realAWSCloudwatch$realAWSCloudwatch[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_ml_lstm_numenta_real_aws)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_ml_lstm_numenta_real_aws[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
## Final tasks ===============
#Cleaning the results to manage session memory and avoid mistakes
rm(result_243_arima_numenta_real_aws)
rm(result_243_cf_lr_numenta_real_aws)
rm(result_243_fbiad_numenta_real_aws)
rm(result_243_garch_numenta_real_aws)
rm(result_243_ml_lstm_numenta_real_aws)
...
#If not sure, use individual files instead of complete experiment
load(file="~/janio/harbinger/dev/results/result_243_fbiad_numenta_real_knwcs.RData")
load(file="~/janio/harbinger/dev/results/result_243_arima_numenta_real_knwcs.RData")
load(file="~/janio/harbinger/dev/results/result_243_garch_numenta_real_knwcs.RData")
load(file="~/janio/harbinger/dev/results/result_243_cf_lr_numenta_real_knwcs.RData")
load(file="~/janio/harbinger/dev/results/result_243_ml_lstm_numenta_real_knwcs.RData")
...
for (k in 1:length(result_243_fbiad_numenta_real_knwcs)) {
  ev_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(result_243_fbiad_numenta_real_knwcs[[k]]$detector,
             result_243_fbiad_numenta_real_knwcs[[k]]$detection$event,
...
for (k in 1:length(result_243_fbiad_numenta_real_knwcs)) {
  ev_soft_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_fbiad_numenta_real_knwcs[[k]]$detection$event),
...
names(ev_soft_numenta_243_fbiad) <- names(numenta_realKnownCause$realKnownCause)
...
j = 1
for (j in 1:length(result_243_fbiad_numenta_real_knwcs)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_fbiad_numenta_real_knwcs[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_arima_numenta_real_knwcs)) {
  ev_numenta_243_arima[[k]] <- tryCatch({
    evaluate(result_243_arima_numenta_real_knwcs[[k]]$detector,
             result_243_arima_numenta_real_knwcs[[k]]$detection$event,
             numenta_realKnownCause$realKnownCause[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_arima_numenta_real_knwcs)) {
  ev_soft_numenta_243_arima[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_arima_numenta_real_knwcs[[k]]$detection$event),
             as.logical(numenta_realKnownCause$realKnownCause[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_arima) <- names(numenta_realKnownCause$realKnownCause)
...
j = 1
for (j in 1:length(result_243_arima_numenta_real_knwcs)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_arima_numenta_real_knwcs[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_garch_numenta_real_knwcs)) {
  ev_numenta_243_garch[[k]] <- tryCatch({
    evaluate(result_243_garch_numenta_real_knwcs[[k]]$detector,
             result_243_garch_numenta_real_knwcs[[k]]$detection$event,
             numenta_realKnownCause$realKnownCause[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_garch_numenta_real_knwcs)) {
  ev_soft_numenta_243_garch[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_garch_numenta_real_knwcs[[k]]$detection$event),
             as.logical(numenta_realKnownCause$realKnownCause[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_garch_numenta_real_knwcs)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_garch_numenta_real_knwcs[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_cf_lr_numenta_real_knwcs)) {
  ev_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(result_243_cf_lr_numenta_real_knwcs[[k]]$detector,
             result_243_cf_lr_numenta_real_knwcs[[k]]$detection$event,
             numenta_realKnownCause$realKnownCause[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_cf_lr_numenta_real_knwcs)) {
  ev_soft_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_cf_lr_numenta_real_knwcs[[k]]$detection$event),
             as.logical(numenta_realKnownCause$realKnownCause[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_cf_lr_numenta_real_knwcs)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_cf_lr_numenta_real_knwcs[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_ml_lstm_numenta_real_knwcs)) {
  ev_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(result_243_ml_lstm_numenta_real_knwcs[[k]]$detector,
             result_243_ml_lstm_numenta_real_knwcs[[k]]$detection$event,
             numenta_realKnownCause$realKnownCause[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_ml_lstm_numenta_real_knwcs)) {
  ev_soft_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_ml_lstm_numenta_real_knwcs[[k]]$detection$event),
             as.logical(numenta_realKnownCause$realKnownCause[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
j = 1
for (j in 1:length(result_243_ml_lstm_numenta_real_knwcs)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_ml_lstm_numenta_real_knwcs[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
## Final tasks ===============
#Cleaning the results to manage session memory and avoid mistakes
rm(result_243_arima_numenta_real_knwcs)
rm(result_243_cf_lr_numenta_real_knwcs)
rm(result_243_fbiad_numenta_real_knwcs)
rm(result_243_garch_numenta_real_knwcs)
rm(result_243_ml_lstm_numenta_real_knwcs)
...
load(file="~/janio/harbinger/dev/results/result_243_fbiad_numenta_real_traff.RData")
load(file="~/janio/harbinger/dev/results/result_243_arima_numenta_real_traff.RData")
load(file="~/janio/harbinger/dev/results/result_243_garch_numenta_real_traff.RData")
load(file="~/janio/harbinger/dev/results/result_243_cf_lr_numenta_real_traff.RData")
load(file="~/janio/harbinger/dev/results/result_243_ml_lstm_numenta_real_traff.RData")
...
for (k in 1:length(result_243_fbiad_numenta_real_traff)) {
  ev_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(result_243_fbiad_numenta_real_traff[[k]]$detector,
             result_243_fbiad_numenta_real_traff[[k]]$detection$event,
...
for (k in 1:length(result_243_fbiad_numenta_real_traff)) {
  ev_soft_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_fbiad_numenta_real_traff[[k]]$detection$event),
...
names(ev_soft_numenta_243_fbiad) <- names(numenta_realTraffic$realTraffic)
...
j = 1
for (j in 1:length(result_243_fbiad_numenta_real_traff)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_fbiad_numenta_real_traff[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_arima_numenta_real_traff)) {
  ev_numenta_243_arima[[k]] <- tryCatch({
    evaluate(result_243_arima_numenta_real_traff[[k]]$detector,
             result_243_arima_numenta_real_traff[[k]]$detection$event,
             numenta_realTraffic$realTraffic[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_arima_numenta_real_traff)) {
  ev_soft_numenta_243_arima[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_arima_numenta_real_traff[[k]]$detection$event),
             as.logical(numenta_realTraffic$realTraffic[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_arima) <- names(numenta_realTraffic$realTraffic)
...
j = 1
for (j in 1:length(result_243_arima_numenta_real_traff)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_arima_numenta_real_traff[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_garch_numenta_real_traff)) {
  ev_numenta_243_garch[[k]] <- tryCatch({
    evaluate(result_243_garch_numenta_real_traff[[k]]$detector,
             result_243_garch_numenta_real_traff[[k]]$detection$event,
             numenta_realTraffic$realTraffic[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_garch_numenta_real_traff)) {
  ev_soft_numenta_243_garch[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_garch_numenta_real_traff[[k]]$detection$event),
             as.logical(numenta_realTraffic$realTraffic[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_garch) <- names(numenta_realTraffic$realTraffic)
...
j = 1
for (j in 1:length(result_243_garch_numenta_real_traff)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_garch_numenta_real_traff[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_cf_lr_numenta_real_traff)) {
  ev_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(result_243_cf_lr_numenta_real_traff[[k]]$detector,
             result_243_cf_lr_numenta_real_traff[[k]]$detection$event,
             numenta_realTraffic$realTraffic[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_cf_lr_numenta_real_traff)) {
  ev_soft_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_cf_lr_numenta_real_traff[[k]]$detection$event),
             as.logical(numenta_realTraffic$realTraffic[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_cf_lr) <- names(numenta_realTraffic$realTraffic)
...
j = 1
for (j in 1:length(result_243_cf_lr_numenta_real_traff)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_cf_lr_numenta_real_traff[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_ml_lstm_numenta_real_traff)) {
  ev_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(result_243_ml_lstm_numenta_real_traff[[k]]$detector,
             result_243_ml_lstm_numenta_real_traff[[k]]$detection$event,
             numenta_realTraffic$realTraffic[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_ml_lstm_numenta_real_traff)) {
  ev_soft_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_ml_lstm_numenta_real_traff[[k]]$detection$event),
             as.logical(numenta_realTraffic$realTraffic[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_ml_lstm) <- names(numenta_realTraffic$realTraffic)
...
j = 1
for (j in 1:length(result_243_ml_lstm_numenta_real_traff)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_ml_lstm_numenta_real_traff[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
## Final tasks ===============
#Cleaning the results to manage session memory and avoid mistakes
rm(result_243_arima_numenta_real_traff)
rm(result_243_cf_lr_numenta_real_traff)
rm(result_243_fbiad_numenta_real_traff)
rm(result_243_garch_numenta_real_traff)
rm(result_243_ml_lstm_numenta_real_traff)
...
#Before using loaded data verify if it has the complete experiment results
#If not sure, use individual files instead of the complete experiment
load(file="~/janio/harbinger/dev/results/result_243_fbiad_numenta_real_tweets.RData")
load(file="~/janio/harbinger/dev/results/result_243_arima_numenta_real_tweets.RData")
load(file="~/janio/harbinger/dev/results/result_243_garch_numenta_real_tweets.RData")
load(file="~/janio/harbinger/dev/results/result_243_cf_lr_numenta_real_tweets.RData")
load(file="~/janio/harbinger/dev/results/result_243_ml_lstm_numenta_real_tweets.RData")
...
for (k in 1:length(result_243_fbiad_numenta_real_tweets)) {
  ev_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(result_243_fbiad_numenta_real_tweets[[k]]$detector,
             result_243_fbiad_numenta_real_tweets[[k]]$detection$event,
...
for (k in 1:length(result_243_fbiad_numenta_real_tweets)) {
  ev_soft_numenta_243_fbiad[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_fbiad_numenta_real_tweets[[k]]$detection$event),
...
names(ev_soft_numenta_243_fbiad) <- names(numenta_realTweets$realTweets)
...
j = 1
for (j in 1:length(result_243_fbiad_numenta_real_tweets)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_fbiad_numenta_real_tweets[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_arima_numenta_real_tweets)) {
  ev_numenta_243_arima[[k]] <- tryCatch({
    evaluate(result_243_arima_numenta_real_tweets[[k]]$detector,
             result_243_arima_numenta_real_tweets[[k]]$detection$event,
             numenta_realTweets$realTweets[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_arima_numenta_real_tweets)) {
  ev_soft_numenta_243_arima[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_arima_numenta_real_tweets[[k]]$detection$event),
             as.logical(numenta_realTweets$realTweets[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_arima) <- names(numenta_realTweets$realTweets)
...
j = 1
for (j in 1:length(result_243_arima_numenta_real_tweets)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_arima_numenta_real_tweets[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_garch_numenta_real_tweets)) {
  ev_numenta_243_garch[[k]] <- tryCatch({
    evaluate(result_243_garch_numenta_real_tweets[[k]]$detector,
             result_243_garch_numenta_real_tweets[[k]]$detection$event,
             numenta_realTweets$realTweets[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_garch_numenta_real_tweets)) {
  ev_soft_numenta_243_garch[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_garch_numenta_real_tweets[[k]]$detection$event),
             as.logical(numenta_realTweets$realTweets[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_garch) <- names(numenta_realTweets$realTweets)
...
j = 1
for (j in 1:length(result_243_garch_numenta_real_tweets)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_garch_numenta_real_tweets[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_cf_lr_numenta_real_tweets)) {
  ev_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(result_243_cf_lr_numenta_real_tweets[[k]]$detector,
             result_243_cf_lr_numenta_real_tweets[[k]]$detection$event,
             numenta_realTweets$realTweets[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_cf_lr_numenta_real_tweets)) {
  ev_soft_numenta_243_cf_lr[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_cf_lr_numenta_real_tweets[[k]]$detection$event),
             as.logical(numenta_realTweets$realTweets[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_cf_lr) <- names(numenta_realTweets$realTweets)
...
j = 1
for (j in 1:length(result_243_cf_lr_numenta_real_tweets)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_cf_lr_numenta_real_tweets[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
for (k in 1:length(result_243_ml_lstm_numenta_real_tweets)) {
  ev_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(result_243_ml_lstm_numenta_real_tweets[[k]]$detector,
             result_243_ml_lstm_numenta_real_tweets[[k]]$detection$event,
             numenta_realTweets$realTweets[[k]]$event)
  }, error = function(e) {
    message(e)
    return(NA)
...
for (k in 1:length(result_243_ml_lstm_numenta_real_tweets)) {
  ev_soft_numenta_243_ml_lstm[[k]] <- tryCatch({
    evaluate(har_eval_soft(),
             as.logical(result_243_ml_lstm_numenta_real_tweets[[k]]$detection$event),
             as.logical(numenta_realTweets$realTweets[[k]]$event))
  }, error = function(e) {
    message(e)
    return(NA)
...
names(ev_soft_numenta_243_ml_lstm) <- names(numenta_realTweets$realTweets)
...
j = 1
for (j in 1:length(result_243_ml_lstm_numenta_real_tweets)) {
  time_bt_partial <- tryCatch({
    append(time_bt_partial, diff(result_243_ml_lstm_numenta_real_tweets[[j]]$time))
  }, error = function(e) {
    message(e)
    return(append(time_bt_partial, NA))
  })
...
## Final tasks ===============
#Cleaning the results to manage session memory and avoid mistakes
rm(result_243_arima_numenta_real_tweets)
rm(result_243_cf_lr_numenta_real_tweets)
rm(result_243_fbiad_numenta_real_tweets)
rm(result_243_garch_numenta_real_tweets)
rm(result_243_ml_lstm_numenta_real_tweets)
...
##=====
## Save final results
save(numenta_243_cons, file = "~/janio/harbinger/dev/results/numenta_243_cons.RData", compress = TRUE)
numenta_243_cons
...
##ACC
numenta_243_cons_overall$acc <- data.frame(method = "FBIAD", value = mean(acc_numenta_243_fbiad, na.rm = TRUE))
numenta_243_cons_overall$acc <- rbind(numenta_243_cons_overall$acc, c(method = "ARIMA", value = mean(acc_numenta_243_arima, na.rm = TRUE)))
numenta_243_cons_overall$acc <- rbind(numenta_243_cons_overall$acc, c(method = "GARCH", value = mean(acc_numenta_243_garch, na.rm = TRUE)))
numenta_243_cons_overall$acc <- rbind(numenta_243_cons_overall$acc, c(method = "CF_LR", value = mean(acc_numenta_243_cf_lr, na.rm = TRUE)))
numenta_243_cons_overall$acc <- rbind(numenta_243_cons_overall$acc, c(method = "ML_LSTM", value = mean(acc_numenta_243_ml_lstm, na.rm = TRUE)))

##F1
numenta_243_cons_overall$f1 <- data.frame(method = "FBIAD", value = mean(f1_numenta_243_fbiad, na.rm = TRUE))
numenta_243_cons_overall$f1 <- rbind(numenta_243_cons_overall$f1, c(method = "ARIMA", value = mean(f1_numenta_243_arima, na.rm = TRUE)))
numenta_243_cons_overall$f1 <- rbind(numenta_243_cons_overall$f1, c(method = "GARCH", value = mean(f1_numenta_243_garch, na.rm = TRUE)))
numenta_243_cons_overall$f1 <- rbind(numenta_243_cons_overall$f1, c(method = "CF_LR", value = mean(f1_numenta_243_cf_lr, na.rm = TRUE)))
numenta_243_cons_overall$f1 <- rbind(numenta_243_cons_overall$f1, c(method = "ML_LSTM", value = mean(f1_numenta_243_ml_lstm, na.rm = TRUE)))

##F1 SOFT
numenta_243_cons_overall$f1_soft <- data.frame(method = "FBIAD", value = mean(f1_soft_numenta_243_fbiad, na.rm = TRUE))
numenta_243_cons_overall$f1_soft <- rbind(numenta_243_cons_overall$f1_soft, c(method = "ARIMA", value = mean(f1_soft_numenta_243_arima, na.rm = TRUE)))
numenta_243_cons_overall$f1_soft <- rbind(numenta_243_cons_overall$f1_soft, c(method = "GARCH", value = mean(f1_soft_numenta_243_garch, na.rm = TRUE)))
numenta_243_cons_overall$f1_soft <- rbind(numenta_243_cons_overall$f1_soft, c(method = "CF_LR", value = mean(f1_soft_numenta_243_cf_lr, na.rm = TRUE)))
numenta_243_cons_overall$f1_soft <- rbind(numenta_243_cons_overall$f1_soft, c(method = "ML_LSTM", value = mean(f1_soft_numenta_243_ml_lstm, na.rm = TRUE)))

##TIME
numenta_243_cons_overall$time_per_batch <- data.frame(method = "FBIAD", value = mean(time_per_batch_numenta_243_fbiad, na.rm = TRUE))
numenta_243_cons_overall$time_per_batch <- rbind(numenta_243_cons_overall$time_per_batch, c(method = "ARIMA", value = mean(time_per_batch_numenta_243_arima, na.rm = TRUE)))
numenta_243_cons_overall$time_per_batch <- rbind(numenta_243_cons_overall$time_per_batch, c(method = "GARCH", value = mean(time_per_batch_numenta_243_garch, na.rm = TRUE)))
numenta_243_cons_overall$time_per_batch <- rbind(numenta_243_cons_overall$time_per_batch, c(method = "CF_LR", value = mean(time_per_batch_numenta_243_cf_lr, na.rm = TRUE)))
numenta_243_cons_overall$time_per_batch <- rbind(numenta_243_cons_overall$time_per_batch, c(method = "ML_LSTM", value = mean(time_per_batch_numenta_243_ml_lstm, na.rm = TRUE)))

numenta_243_cons_overall
save(numenta_243_cons_overall, file = "~/janio/harbinger/dev/results/numenta_243_cons_overall.RData", compress = TRUE)
...
for (k in 1:length(result_243_fbiad_numenta_art_anom)){
  str_numenta_fbiad$art_anom[[k]] <- tryCatch({
    stream_evaluate(nexus_result = result_243_fbiad_numenta_art_anom[[k]])
  }, error = function(e) {
    message(e)
    return(NA)
  })
...
names(str_numenta_fbiad$art_anom) <- names(result_243_fbiad_numenta_art_anom)
...
for (k in 1:length(result_243_arima_numenta_art_anom)){
  str_numenta_arima$art_anom[[k]] <- tryCatch({
    stream_evaluate(nexus_result = result_243_arima_numenta_art_anom[[k]])
  }, error = function(e) {
    message(e)
    return(NA)
  })
...
names(str_numenta_arima$art_anom) <- names(result_243_arima_numenta_art_anom)
