#########################################################
## UCR Anomaly Archive - Build ECG labeled source subset
## - Input: etl/ucr_anomaly/source/ucr.RData (loaded into `ucr`)
## - Output: etl/ucr_anomaly/source/ucr_ecg.RData
## - Notes: selects ECG-related series and saves labeled subset
#########################################################
